...
public class CookieHelper {
    ...
    public static String generateCookie(@NonNull String name, @NonNull String value, @NonNull Duration maxAge,  HttpServletRequest request) {
    ...
    public static String generateExpiredCookie(@NonNull String name) {
        return generateCookie(name, "-", Duration.ZERO, null);
    }
}
